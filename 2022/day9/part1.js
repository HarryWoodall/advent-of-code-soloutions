...
const testCommands = ["R 4", "U 4", "L 3", "D 1", "R 4", "D 1", "L 5", "R 2"];

let ropePositions = [new Vector(0, 0), new Vector(0, 0)];
let currentHeadPosition = new Vector(0, 0);
let currentTailPosition = new Vector(0, 0);
...
function calculateTailPosition(index) {
  ...
  positions.add(JSON.stringify(ropePositions[index]));
}
