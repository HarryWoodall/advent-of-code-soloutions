...
lines.forEach((line) => {
  const nextNumber = calculatePreviousNumber(line, 0);
...
function calculatePreviousNumber(numbers, depth) {
  const differences = getDifferences(numbers);
  ...
  numbers.unshift(numbers.at(0) - calculatePreviousNumber(differences, depth + 1));
